    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","https://ysrjdf.oss-cn-beijing.aliyuncs.com/product/qq.jpg");
        $('.weixin_code').attr("src","https://ysrjdf.oss-cn-beijing.aliyuncs.com/product/mmqrcode1528637141594.png");
    });
