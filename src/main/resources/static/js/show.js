    ...
    function putInArticle(data) {
        ...
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- 夜深人静的风</span>' +
            '</div>');
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="\n' + 'https://ysrjdf.oss-cn-beijing.aliyuncs.com/product/Cache_b66773737b89dcb..jpg">' +
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我的微信公众号：ysrjdf</p>' +
        ...
        //     var imgUrl = imgs.eq(i).attr("src");
        //     imgs.eq(i).attr("src","https://zhy-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/loading.gif");
        //     console.log(imgs.eq(i).attr("src"));
        //     console.log(imgs.eq(i))
        //     imgs.eq(i).attr("data-src",imgUrl);
        //
        // }
    }
